...
class CalculoEngine:
    ...
    def calcular_item(
        ...
        if valor_pintura > 0:
            ...
            custo_pintura = preco_pintura_kg * peso_unitario * quantidade
        else:
            custo_pintura = 0.0
        ...
        # 12. Preço unitário com impostos e tratamento de Valor Final manual
        ...
        if valor_final > 0:
            ...
            valor_venda_sem_imp = preco_total * (1.0 - total_impostos)
        else:
