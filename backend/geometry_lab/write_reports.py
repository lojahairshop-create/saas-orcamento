...
perf_report = """# TRUE SHAPE PERFORMANCE REPORT (Sprint 3.2)
...
with open("docs/TRUE_SHAPE_PERFORMANCE_REPORT.md", "w", encoding="utf-8") as f:
    f.write(perf_report)
...
"""
with open("docs/TRUE_SHAPE_GEOMETRY_LAB.md", "a", encoding="utf-8") as f:
    f.write(append_lab)
